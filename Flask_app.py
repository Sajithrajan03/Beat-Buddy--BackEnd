...
def recommendations():
    ...
    feature_vector,similar_songs = show_similar_songs(song_name, year, dat, all_features, num_recommendations, plot_type='wordcloud')
    ...
    return render_template("index.html",data = similar_songs) 
